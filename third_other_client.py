...
from data import get_data, get_second_data, data_poisoning
...
class Client:
    ...
    def __init__(self, master):
        ...
        X_train, y_train, X_test, y_test = get_second_data()
        self.X_train, self.y_train = shuffle(X_train, y_train, random_state=27)
        self.X_test, self.y_test = shuffle(X_test, y_test, random_state=27)
